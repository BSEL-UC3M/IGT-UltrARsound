...
* Created by Marius Krusen
* Modified by Felix von Haxthausen
*/
...
public class SocketHandler
{
    ...
    {
#if UNITY_EDITOR
        Byte[] bytes = new Byte[512*512+130];
        ...
        return allBytes;
            ...
            byte[] allBytes;
            var loadaction = dr.LoadAsync(263168);
    ...
    //    /// <summary>
    //    /// Method to receive a string from the server.
    //    /// </summary>
    //    /// <returns>Massage the server has sent.</returns>
    ...
    //#else
    //        String response = "";
    //        var loadaction = dr.LoadAsync(512);
    //        // Block the thread while loading
    //        while (loadaction.Status != AsyncStatus.Completed)
    //        {
    //        }
    ...
    //        if (loadaction.GetResults() > 0)
    //        {
    //            response = dr.ReadString(loadaction.GetResults());
    //        }
