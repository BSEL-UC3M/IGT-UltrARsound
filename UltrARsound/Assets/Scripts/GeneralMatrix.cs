...
namespace Ultrasound.Tracking
{
    ...
    [Serializable]
    public class GeneralMatrix : System.ICloneable, System.IDisposable
    {
        ...
        {
            return (new SingularValueDecomp(this).Norm2());
        }
        ...
        public virtual SingularValueDecomp SVD()
        {
            return new SingularValueDecomp(this);
        }
        ...
        {
            return new SingularValueDecomp(this).Rank();
        }
        ...
        {
            return new SingularValueDecomp(this).Condition();
        }
